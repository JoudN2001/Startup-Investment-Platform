...
export default function SignInPage() {
  ...
  const onSignIn = (data: signInObj) => {
    // DEMO USERS
    const adminUser = process.env.NEXT_PUBLIC_DEMO_ADMIN_USER;
    const adminPass = process.env.NEXT_PUBLIC_DEMO_ADMIN_PASS;
    const startupUser = process.env.NEXT_PUBLIC_DEMO_STARTUP_USER;
    const startupPass = process.env.NEXT_PUBLIC_DEMO_STARTUP_PASS;
    const investorUser = process.env.NEXT_PUBLIC_DEMO_INVESTOR_USER;
    const investorPass = process.env.NEXT_PUBLIC_DEMO_INVESTORS_PASS;
