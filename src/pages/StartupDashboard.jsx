...
export default function StartupDashboard() {
  ...
  return (
      <div className={"bg-neutral-950 w-full min-h-dvh"}>
        ...
        <ResponsiveContainer>
          <div
            className={"lg:flex lg:items-center lg:justify-between lg:mb-8  "}
          >
            {/* OVERVIEW */}
            <div>
              <span
              ...
              >
                ...
                alias illo dolorem, voluptatem asperiores obcaecati rerum
                voluptas dolores similique iste reprehenderit saepe, quasi
                voluptatibus, earum non! Aliquid tenetur deserunt incidunt!
              </p>
            </div>
            {/* ===== OVERVIEW ===== */}
