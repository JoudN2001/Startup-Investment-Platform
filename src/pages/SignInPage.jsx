  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-neutral-950 p-4 font-sans text-neutral-100">
      ...
      >
        ...
        <button
          type="submit"
          className="mt-2 h-12 w-full bg-neutral-100 text-white font-medium text-[15px] rounded-xl hover:bg-neutral-200 transition-colors duration-200"
        >
          Sign In
        </button>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            type="button"
            className="flex-1 h-12 flex justify-center items-center gap-2.5 font-medium border border-neutral-800 bg-white rounded-xl cursor-pointer transition-colors duration-200 hover:border-tertiary-500 text-sm"
          >
